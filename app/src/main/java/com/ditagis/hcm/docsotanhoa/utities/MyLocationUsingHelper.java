...
public class MyLocationUsingHelper extends AppCompatActivity implements ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                returnIntent.putExtra(getString(R.string.ket_qua_location_loc), getAddressLine());
                returnIntent.putExtra(getString(R.string.ket_qua_location_long), longitude);
                returnIntent.putExtra(getString(R.string.ket_qua_location_lat), latitude);
    ...
    public String getAddressLine() {
        ...
        if (locationAddress != null) {
            return locationAddress.getAddressLine(0);
        }
        return "";
    }
