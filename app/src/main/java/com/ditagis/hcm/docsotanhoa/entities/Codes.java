...
public class Codes {
    ...
    private Codes() {
        codeDescribles = new Code_Describle[]{new Code_Describle("40", " Bình thường"),
                ...
                new Code_Describle("55", " Giải trình codeDescribles 5 kỳ trước"),
                new Code_Describle("56", " Giải trình codeDescribles 6 kỳ trước\nKỳ này đọc được"),
                new Code_Describle("58", " Giải trình codeDescribles 8 kỳ trước"),
                new Code_Describle("5F", " Giải trình codeDescribles F kỳ trước"),
                new Code_Describle("5M", " Giải trình codeDescribles M kỳ trước"),
                new Code_Describle("5Q", " Giải trình codeDescribles Q kỳ trước"),
                new Code_Describle("5K", " Giải trình codeDescribles K kỳ trước"),
                new Code_Describle("5N", " Giải trình codeDescribles N kỳ trước"),
